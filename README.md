...
If the video contains subtitles, they will be shown and you can save/share these transcripts in whole, or copy a portion to the clipboard (with or without the timestamps). You can also switch to the same transcript in any of the available languages. And you can select a starting point (or a section) and launch or copy the link to play that part of the video in the language you choose.
...
<img src="docs/res/language.png" width=20> switch to another language; recently selected languages listed first; then "top" languages; then remaining available languages; if there was a selection on language switch, the approximate location will be selected in the new language
